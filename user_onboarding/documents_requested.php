                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Documents Requested</h4>
                                    ...
                                    <table class="table table-bordered mb-0 table-centered">
                                        ...
                                        <tbody>
                                          <?php
                                            ...
                                            try{
                                              $stmt = $conn->prepare("SELECT *, documents.id AS fileid FROM documents LEFT JOIN documents_list ON documents.file_id = documents_list.id WHERE user_id=:user_id AND file_status=:file_status AND documents.soft_delete=0");
                                              ...
                                              foreach($stmt as $file){
                                                echo "
                                                  <tr>
                                                    ...
                                                    <td class='text-right'>
                                                      <a href='document_requested_submit.php?did=".$file['fileid']."' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-external-link'></i> Submit</a>
                                                    </td>
                                                  </tr>
                                                ";
                                              }
