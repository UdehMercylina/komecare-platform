  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pending Shifts</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Manchester</td>
                    <td>
                      <button class='btn btn-primary btn-sm msg btn-flat'><i class='fa fa-calendar'></i> Timesheet</button>
                      <a href='job_details' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-briefcase'></i> Job Details</a>
                      <button class='btn btn-info btn-sm edit btn-flat'><i class='fa fa-edit'></i> Edit</button>
                    </td>
                  </tr>
                </tbody>
              </table>
