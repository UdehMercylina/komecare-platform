...
if(isset($_POST['delete'])){
	...
	try{
	    ...
	    $activity->execute(['user_id'=>$admin["id"], 'message'=>'Cancelled '.$curr_det["full_name"].' application', 'category'=>'Audit', 'date_sent'=>$now]);

		$_SESSION['success'] = 'User application rejected';
	}
