    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Add New Stakeholder</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="stakeholders_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="firstname" class="col-sm-3 control-label">Contact Firstname</label>
                ...
                <div class="form-group">
                    <label for="lastname" class="col-sm-3 control-label">Contact Lastname</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Revoking...</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="stakeholders_soft_delete.php">
                <input type="hidden" class="userid" name="id">
                <div class="text-center">
                    <p>REVOKE STAKEHOLDER</p>
                    <h2 class="bold business_name"></h2>
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-danger btn-flat" name="delete"><i class="fa fa-trash"></i> Revoke</button>
              </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="restore">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="stakeholders_restore.php">
                <input type="hidden" class="userid" name="id">
                <div class="text-center">
                    <p>RESTORE STAKEHOLDER</p>
                    <h2 class="bold business_name"></h2>
                </div>
            </div>
            <div class="modal-footer">
