    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Add New Shift</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="shift_add.php" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="stakeholder" class="col-sm-2 control-label">Business Name</label>

                  <div class="col-sm-10">
                    <select class="form-control" id="stakeholder" name="stakeholder_id" required>
                ...
                <div class="form-group">
                  <label for="task_title" class="col-sm-1 control-label">Task Title</label>
                ...
                <div class="form-group">
                  <label for="business_unit" class="col-sm-1 control-label">Business Unit</label>
                ...
                <div class="form-group">
                  <label for="shift_location" class="col-sm-1 control-label">Shift Location</label>

                  <div class="col-sm-11">
                    <input type="text" class="form-control" id="shift_location" name="shift_location" required>
                  </div>

                </div>

                <div class="form-group">
                  <label for="shift_start_date" class="col-sm-1 control-label">Shift Start Date</label>

                  <div class="col-sm-11">
                    <input type="datetime-local" class="form-control" id="shift_start_date" name="shift_start_date" required>
                  </div>

                </div>

                <div class="form-group">
                  <label for="shift_due_date" class="col-sm-1 control-label">Shift Completion Date</label>

                  <div class="col-sm-11">
                    <input type="datetime-local" class="form-control" id="shift_due_date" name="shift_due_date" required>
                  </div>
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    <textarea id="task_description_summary" name="task_description_summary" rows="5" cols="100" required></textarea>
                  </div>
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    <textarea id="editor1" name="task_description" rows="10" cols="80" required></textarea>
                  </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Assign Shift</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="shift_assign.php">
                <input type="hidden" class="shift_id" name="id">
                <div class="form-group">
