  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Unassigned Shifts</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM shift LEFT JOIN users ON shift.stakeholder_id=users.id WHERE candidate_id IS NULL");
                      $stmt->execute();
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              ...
                              <button class='btn btn-info btn-sm assign btn-flat' data-id='".$row['shift_id']."'><i class='fa fa-edit'></i> Assign</button>
                              <button class='btn btn-info btn-sm edit btn-flat' data-id='".$row['shift_id']."'><i class='fa fa-edit'></i> Edit</button>
