  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Active Shifts</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM shift LEFT JOIN users ON shift.stakeholder_id=users.id WHERE stakeholder_approval IS NULL AND candidate_id IS NOT NULL");
                      $stmt->execute();
                      foreach($stmt as $row){
